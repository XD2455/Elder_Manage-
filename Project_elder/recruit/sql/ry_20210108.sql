...
values  (1, '超级管理员', 'admin', 1, '1', 1, 1, '0', '0', 'admin', '2021-03-24 17:15:48', '', null, '超级管理员'),
        ...
        (101, '求职者', 'student', 4, '1', 1, 1, '0', '0', 'admin', '2021-04-20 09:08:23', '', null, null),
...
values  (1, '系统管理', 0, 1, 'system', null, 1, 0, 'M', '0', '0', '', 'system', 'admin', '2021-03-24 17:15:49', '', null, '系统管理目录'),
        ...
        (100, '求职者管理', 2063, 1, 'user', 'system/user/index', 1, 0, 'C', '0', '0', 'system:user:list', 'user', 'admin', '2021-03-24 17:15:50', 'admin', '2021-04-30 14:43:10', '用户管理菜单'),
        ...
        (2019, '招聘岗位', 2000, 1, 'position', 'system/recruit/position/index', 1, 0, 'C', '0', '0', 'recruit:position:list', 'component', 'admin', '2021-03-25 09:12:09', 'admin', '2021-05-11 12:43:18', '招聘岗位菜单'),
        (2020, '招聘岗位查询', 2019, 1, '#', '', 1, 0, 'F', '0', '0', 'recruit:position:query', '#', 'admin', '2021-03-25 09:12:11', '', null, ''),
        (2021, '招聘岗位新增', 2019, 2, '#', '', 1, 0, 'F', '0', '0', 'recruit:position:add', '#', 'admin', '2021-03-25 09:12:11', '', null, ''),
        (2022, '招聘岗位修改', 2019, 3, '#', '', 1, 0, 'F', '0', '0', 'recruit:position:edit', '#', 'admin', '2021-03-25 09:12:12', '', null, ''),
        (2023, '招聘岗位删除', 2019, 4, '#', '', 1, 0, 'F', '0', '0', 'recruit:position:remove', '#', 'admin', '2021-03-25 09:12:12', '', null, ''),
        (2024, '招聘岗位导出', 2019, 5, '#', '', 1, 0, 'F', '0', '0', 'recruit:position:export', '#', 'admin', '2021-03-25 09:12:13', '', null, ''),
        ...
        (2049, '求职者简历信息', 2000, 1, 'resume', 'system/recruit/resume/index', 1, 0, 'C', '0', '0', 'recruit:resume:list', 'education', 'admin', '2021-04-03 21:30:06', 'admin', '2021-05-11 12:44:20', '求职者简历信息菜单'),
        (2050, '求职者简历信息查询', 2049, 1, '#', '', 1, 0, 'F', '0', '0', 'recruit:resume:query', '#', 'admin', '2021-04-03 21:30:08', '', null, ''),
        (2051, '求职者简历信息新增', 2049, 2, '#', '', 1, 0, 'F', '0', '0', 'recruit:resume:add', '#', 'admin', '2021-04-03 21:30:08', '', null, ''),
        (2052, '求职者简历信息修改', 2049, 3, '#', '', 1, 0, 'F', '0', '0', 'recruit:resume:edit', '#', 'admin', '2021-04-03 21:30:09', '', null, ''),
        (2053, '求职者简历信息删除', 2049, 4, '#', '', 1, 0, 'F', '0', '0', 'recruit:resume:remove', '#', 'admin', '2021-04-03 21:30:09', '', null, ''),
        (2054, '求职者简历信息导出', 2049, 5, '#', '', 1, 0, 'F', '0', '0', 'recruit:resume:export', '#', 'admin', '2021-04-03 21:30:10', '', null, ''),
        (2055, '求职者个人信息', 2000, 1, 'student', 'system/recruit/student/index', 1, 0, 'C', '0', '0', 'recruit:student:list', '#', 'admin', '2021-04-03 21:30:20', 'admin', '2021-05-05 23:39:10', '求职者个人信息菜单'),
        (2056, '求职者个人信息查询', 2055, 1, '#', '', 1, 0, 'F', '0', '0', 'recruit:student:query', '#', 'admin', '2021-04-03 21:30:21', '', null, ''),
        (2057, '求职者个人信息新增', 2055, 2, '#', '', 1, 0, 'F', '0', '0', 'recruit:student:add', '#', 'admin', '2021-04-03 21:30:21', '', null, ''),
        (2058, '求职者个人信息修改', 2055, 3, '#', '', 1, 0, 'F', '0', '0', 'recruit:student:edit', '#', 'admin', '2021-04-03 21:30:22', '', null, ''),
        (2059, '求职者个人信息删除', 2055, 4, '#', '', 1, 0, 'F', '0', '0', 'recruit:student:remove', '#', 'admin', '2021-04-03 21:30:23', '', null, ''),
        (2060, '求职者个人信息导出', 2055, 5, '#', '', 1, 0, 'F', '0', '0', 'recruit:student:export', '#', 'admin', '2021-04-03 21:30:23', '', null, ''),
