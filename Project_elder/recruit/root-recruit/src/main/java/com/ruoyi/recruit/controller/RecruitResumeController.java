...
public class RecruitResumeController extends BaseController {
    ...
    @Log(title = "求职者简历信息", businessType = BusinessType.EXPORT)
    @GetMapping("/export")
    ...
    @Log(title = "求职者简历信息", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "求职者简历信息", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "求职者简历信息", businessType = BusinessType.DELETE)
    @DeleteMapping("/{ids}")
