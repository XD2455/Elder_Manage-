...
export default {
  ...
  data(){
    return{
      activeIndex:'0',
      // items:[["首页","岗位"],["投递信息","个人信息","培训活动"],["企业注册","用户登录"]],
      items:[["首页","职位列表"],["个人信息","培训通知"],["用户注册","用户登录","管理员登录"]],
      ...
      navTos:["/recruit/f/index","/recruit/f/position","/recruit/f/resume","/recruit/f/lecture","/recruit/f/register","/recruit/f/login","/login"]
    }
  },
  computed:{
    ...mapGetters([
