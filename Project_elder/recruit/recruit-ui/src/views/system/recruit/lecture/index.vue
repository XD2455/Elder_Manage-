<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="100px">
      <el-form-item label="活动名称" prop="companyName">
        <el-input
      ...
      <el-form-item label="培训活动时间" prop="startTime">
        <el-date-picker clearable size="small" style="width: 200px"
                        v-model="queryParams.startTime"
                        type="date"
                        value-format="yyyy-MM-dd"
                        placeholder="选择培训活动时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="培训活动地点" prop="classroom">
        <el-input
          v-model="queryParams.classroom"
          placeholder="请输入培训活动地点"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
        />
...
<!--      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="lectureList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="活动名称" align="center" prop="companyName" />
      ...
      <el-table-column label="培训活动时间" align="center" prop="startTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.startTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="培训活动地点" align="center" prop="classroom" />
...
<!--      <el-table-column label="申请类型" align="center" prop="type" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="活动名称" prop="companyName">
          <el-input v-model="form.companyName" placeholder="请输入活动名称" />
        </el-form-item>
        <el-form-item label="公司地址" prop="companyAddress">
        ...
        <el-form-item label="培训活动地点" prop="classroom">
          <el-select v-model="form.classroom" placeholder="请选择培训活动地点" clearable size="small">
            <el-option
